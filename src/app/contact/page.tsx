...
import { CTA_COPY, CONTACT, STOCK_PHOTOS } from "@/lib/site";
    ...
    <div className="bg-background text-ink">
      ...
      <Container className="space-y-16 py-16 md:py-20">
        <SectionHeading
          ...
          subtitle="Reach out via WhatsApp, email, or visit our Lagos studio. We’ll craft the perfect glam plan for your event."
        />
