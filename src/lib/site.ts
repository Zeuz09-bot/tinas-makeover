export const BRAND = {
  name: "Tinas Makeover",
  fullName: "Tinas Makeover Collective",
...
export const SOCIAL_LINKS = [
  { label: "Instagram", href: "https://instagram.com/tinasmakeover", icon: "instagram" },
...
export const CTA_COPY = {
  hero:
    "As a professional makeup and hair collective, we craft flawless looks that honor your features—weddings, editorials, and everyday glow included.",
  bookNow: "Book Session",
  more: "View Details",
};

export const STOCK_PHOTOS = {
  heroDesktop: "/images/queen-b/home.webp",
  heroMobile: "/images/queen-b/home.webp",
  makeupPalette: "/images/queen-b/birthdays/birthdays (1).jpg",
  hairModel: "/images/queen-b/hair/IMG_1036.jpg",
  bridalBouquet: "/images/queen-b/bridal/weddings (1).jpg",
  eventGlam: "/images/queen-b/birthdays/birthdays (2).jpg",
  trainingSession: "/images/queen-b/hair-installation/HAIR INSTALLATION (1).PNG",
  wigStyling: "/images/queen-b/hair/IMG_1044.jpg",
  salonInterior: "/images/queen-b/special-occasions/SPECIAL OCASSIONS (1).JPG",
  contactAgent: "/images/queen-b/birthdays/birthdays (3).jpg",
  founderPortrait: "/images/queen-b/ceo/CEO PICTURE.JPG",
  glamCloseup: "/images/queen-b/birthdays/birthdays (4).jpg",
  bridalHairDetail: "/images/queen-b/bridal/weddings (2).jpg",
  hairColoring: "/images/queen-b/hair/IMG_1040.jpg",
  galleryVideoPoster: "/images/queen-b/hair/IMG_1044.jpg",
};
